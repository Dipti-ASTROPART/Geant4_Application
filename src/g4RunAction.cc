...
void    MyRunAction::BeginOfRunAction(const G4Run *run)
{
    ...
    man->CreateNtupleDColumn("nPhotonsSiPM1x1");
    man->CreateNtupleDColumn("nPhotonsSiPM3x3");
    ...
    G4int id3 = man->CreateH1("hNPhotonsSiPM1x1", "#Photons at 1x1 SiPM;#Photons; ", 500, 0, 500);
    G4int id4 = man->CreateH1("hNPhotonsSiPM3x3", "#Photons at 3x3 SiPM;#Photons; ", 500, 0, 500);
